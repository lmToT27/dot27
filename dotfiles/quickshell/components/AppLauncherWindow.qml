...
PanelWindow {
    ...
    readonly property var systemCommands: [
        ...
        { name: "Wi-Fi Networks", subtitle: "System Command", icon: "󰤨",
          exec: ["quickshell", "ipc", "call", "wifilist", "toggle"] },
        { name: "Bluetooth Devices", subtitle: "System Command", icon: "󰂯",
          exec: ["quickshell", "ipc", "call", "bluetoothlist", "toggle"] },
